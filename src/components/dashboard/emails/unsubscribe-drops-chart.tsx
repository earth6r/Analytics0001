        ...
        <Card className="h-[450px] w-full shadow">
            <CardHeader className="flex flex-row items-center">
                <div className="grid gap-2">
                    <CardTitle>Unsubscribe Drops</CardTitle>
                    <div>
                        <CardDescription>Unsubscribe Drops over time</CardDescription>
                    </div>
                </div>
            </CardHeader>
...
export default UnsubscribeDropsChart;
