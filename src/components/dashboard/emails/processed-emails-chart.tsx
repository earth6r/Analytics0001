...
const ProcessedEmailsChart = () => {
    ...
    const formattedData = getStats.data?.map((item: any) => {
        return {
            name: item.date,
            ["Processed Emails"]: item.stats[0].metrics.deferred,
        };
    });
        ...
        <Card className="h-[450px] w-full shadow">
            <CardHeader className="flex flex-row items-center">
                <div className="grid gap-2">
                    ...
                    <div>
                        <CardDescription>Processed emails over time</CardDescription>
                    </div>
                </div>
            </CardHeader>
...
export default ProcessedEmailsChart;
