...
const InvalidEmailsChart = () => {
    ...
    const formattedData = getStats.data?.map((item: any) => {
        return {
            name: item.date,
            ["Invalid Emails"]: item.stats[0].metrics.invalid_emails,
        };
    });
        ...
        <Card className="h-[450px] w-full shadow">
            <CardHeader className="flex flex-row items-center">
                <div className="grid gap-2">
                    ...
                    <div>
                        <CardDescription>Invalid emails over time</CardDescription>
                    </div>
                </div>
            </CardHeader>
...
export default InvalidEmailsChart;
