...
const BuyingTimelineNotSureStatsCard = () => {
    ...
    const buyingTimelineNowCount = api.post.getBuyingTimelineNotSureCount.useQuery(
        {},
        {
            refetchInterval: interval,
        }
    );
    const buyingTimelineNowCountDelta = api.post.getBuyingTimelineNotSureCountDelta.useQuery(
        {},
        {
            refetchInterval: interval,
        }
